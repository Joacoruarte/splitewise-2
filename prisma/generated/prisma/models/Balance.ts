...
export type BalanceWhereInput = {
  ...
  userId1?: Prisma.StringFilter<'Balance'> | string;
  userId2?: Prisma.StringFilter<'Balance'> | string;
...
export type BalanceWhereUniqueInput = Prisma.AtLeast<
  {
    id?: string;
    userId1_userId2?: Prisma.BalanceUserId1UserId2CompoundUniqueInput;
    AND?: Prisma.BalanceWhereInput | Prisma.BalanceWhereInput[];
    OR?: Prisma.BalanceWhereInput[];
    NOT?: Prisma.BalanceWhereInput | Prisma.BalanceWhereInput[];
    userId1?: Prisma.StringFilter<'Balance'> | string;
...
export type BalanceScalarWhereWithAggregatesInput = {
  ...
  userId1?: Prisma.StringWithAggregatesFilter<'Balance'> | string;
  userId2?: Prisma.StringWithAggregatesFilter<'Balance'> | string;
...
export type BalanceUserId1UserId2CompoundUniqueInput = {
  userId1: string;
  userId2: string;
};
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'userId1' | 'userId2' | 'amount' | 'lastUpdated',
  ExtArgs['result']['balance']
>;
...
export type BalanceGetPayload<S extends boolean | null | undefined | BalanceDefaultArgs> =
...
> {
  ...
  create<T extends BalanceCreateArgs>(
    ...
    runtime.Types.Result.GetResult<Prisma.$BalancePayload<ExtArgs>, T, 'create', GlobalOmitOptions>,
    never,
    ExtArgs,
    GlobalOmitOptions
  >;
  ...
  delete<T extends BalanceDeleteArgs>(
    ...
    runtime.Types.Result.GetResult<Prisma.$BalancePayload<ExtArgs>, T, 'delete', GlobalOmitOptions>,
    never,
    ExtArgs,
    GlobalOmitOptions
  >;
  ...
  update<T extends BalanceUpdateArgs>(
    ...
    runtime.Types.Result.GetResult<Prisma.$BalancePayload<ExtArgs>, T, 'update', GlobalOmitOptions>,
    never,
    ExtArgs,
    GlobalOmitOptions
  >;
  ...
  upsert<T extends BalanceUpsertArgs>(
    ...
    runtime.Types.Result.GetResult<Prisma.$BalancePayload<ExtArgs>, T, 'upsert', GlobalOmitOptions>,
    never,
    ExtArgs,
    GlobalOmitOptions
  >;
  ...
  >(
    args: Prisma.SubsetIntersection<T, BalanceGroupByArgs, OrderByArg> & InputErrors
...
export interface BalanceFieldRefs {
  ...
  readonly userId1: Prisma.FieldRef<'Balance', 'String'>;
  readonly userId2: Prisma.FieldRef<'Balance', 'String'>;
