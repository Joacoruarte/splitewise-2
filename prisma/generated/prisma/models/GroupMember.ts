...
export type GroupMemberWhereInput = {
  ...
  isAdmin?: Prisma.BoolFilter<'GroupMember'> | boolean;
...
export type GroupMemberScalarWhereWithAggregatesInput = {
  ...
  isAdmin?: Prisma.BoolWithAggregatesFilter<'GroupMember'> | boolean;
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'groupId' | 'userId' | 'isAdmin' | 'createdAt' | 'updatedAt',
  ExtArgs['result']['groupMember']
>;
...
export type GroupMemberGetPayload<S extends boolean | null | undefined | GroupMemberDefaultArgs> =
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, GroupMemberGroupByArgs, OrderByArg> & InputErrors
  ): {} extends InputErrors ? GetGroupMemberGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
  /**
...
export interface GroupMemberFieldRefs {
  ...
  readonly isAdmin: Prisma.FieldRef<'GroupMember', 'Boolean'>;
